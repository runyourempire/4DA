...
The free tier includes everything: all 11 sources, the full scoring engine, behavior learning, MCP server (26 tools for Claude Code and Cursor), and the CLI. It is not a trial.
