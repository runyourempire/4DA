...
```
30 MCP tools for codebase-aware developer intelligence. Local-only, privacy-first.
```
...
```
30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Scores content from Hacker News, arXiv, Reddit, GitHub, and 7 other sources against what you actually build — then surfaces security advisories, breaking changes, knowledge gaps, and decision conflicts. Everything runs locally. Nothing leaves your machine.
```
...
```
- 30 MCP tools across 8 categories — content scoring, decision memory, knowledge gaps, tech radar, agent autonomy, and more
...
**Issue Title:**
```
Add @4da/mcp-server — 30 tools for codebase-aware developer intelligence
```
...
| Website | https://4da.ai |
| Short Description | 30 MCP tools for codebase-aware developer intelligence. Scores content from HN, arXiv, Reddit, GitHub against your actual tech stack. Local-only, privacy-first. |
...
|-------|-------|
| Name | @4da/mcp-server |
| Description | 30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Scores content from Hacker News, arXiv, Reddit, GitHub, and 7 other sources against what you actually build. Privacy-first — everything runs locally. |
...
|-------|-------|
| Server Name | @4da/mcp-server |
| One-line Description | 30 MCP tools for codebase-aware developer intelligence. Local-only, privacy-first. |
| Full Description | 30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Scores content from Hacker News, arXiv, Reddit, GitHub, and 7 other sources against what you actually build — then surfaces security advisories, breaking changes, knowledge gaps, and decision conflicts. Everything runs locally. Nothing leaves your machine. |
...
**Issue Title:**
```
[MCP Server] @4da/mcp-server — 30 tools for codebase-aware developer intelligence
```
...
### Description
30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Scores content from Hacker News, arXiv, Reddit, GitHub against what you actually build. Privacy-first — everything runs locally.
...
```json
{
  ...
  "meta": {
    ...
    "description": "30 MCP tools for codebase-aware developer intelligence. Scores content from HN, arXiv, Reddit, GitHub against your actual tech stack. Local-only, privacy-first.",
...
|-------|-------|
| Server Name | @4da/mcp-server |
| Short Description | 30 MCP tools for codebase-aware developer intelligence. Local-only, privacy-first. |
| Full Description | 30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Scores content from Hacker News, arXiv, Reddit, GitHub, and 7 other sources against what you actually build — then surfaces security advisories, breaking changes, knowledge gaps, and decision conflicts. Everything runs locally. Nothing leaves your machine. |
| npm URL | https://www.npmjs.com/package/@4da/mcp-server |
| GitHub URL | https://github.com/runyourempire/4DA/tree/main/mcp-4da-server |
| Website | https://4da.ai |
...
|-------|-------|
| Name | @4da/mcp-server |
| Description | 30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Scores content from Hacker News, arXiv, Reddit, GitHub, and 7 other sources against what you actually build. Privacy-first — everything runs locally, zero network calls, no telemetry. |
| npm | https://www.npmjs.com/package/@4da/mcp-server |
| Repository | https://github.com/runyourempire/4DA/tree/main/mcp-4da-server |
| Homepage | https://4da.ai |
| Install Command | npx @4da/mcp-server --setup |
...
|-------|-------|
| Name | @4da/mcp-server |
| Tagline | 30 MCP tools for codebase-aware developer intelligence |
| Description | An MCP server that connects Claude Code, Cursor, Copilot, and Windsurf to a local developer intelligence engine. Provides 30 tools that score content from Hacker News, arXiv, Reddit, GitHub against your actual tech stack — surfacing security advisories, breaking changes, knowledge gaps, and decision conflicts. Everything runs locally. Nothing leaves your machine. MIT licensed. |
| Website | https://4da.ai |
| GitHub | https://github.com/runyourempire/4DA/tree/main/mcp-4da-server |
...
```markdown
- [4DA](https://4da.ai) - Privacy-first developer intelligence desktop app built with Tauri 2.0. Includes an MCP server with 30 tools for codebase-aware content scoring, decision memory, and knowledge gap detection.
```
...
4DA is a Tauri 2.0 desktop app (Rust + React + TypeScript + SQLite) that surfaces developer-relevant content from the internet — privately, locally, with zero configuration. It includes an npm-published MCP server (`@4da/mcp-server`) with 30 tools for AI coding assistants.
...
```markdown
- [@4da/mcp-server](https://www.npmjs.com/package/@4da/mcp-server) - 30 tools for codebase-aware developer intelligence. Scores HN, arXiv, Reddit, GitHub content against your tech stack. Decision memory, knowledge gaps, tech radar. Local-only, privacy-first.
```

**PR Title:**
```
Add @4da/mcp-server — codebase-aware developer intelligence (30 tools)
```
...
30 MCP tools that give AI coding assistants awareness of your tech stack, dependencies, and architectural decisions. Reads your project files (package.json, Cargo.toml, go.mod, etc.) and scores content from 10+ sources against what you actually build.
...
```markdown
- [@4da/mcp-server](https://www.npmjs.com/package/@4da/mcp-server) - 30 MCP tools for codebase-aware developer intelligence. Scores content from HN, arXiv, Reddit, GitHub against your actual tech stack. Includes decision memory, knowledge gap detection, and agent session handoff. Privacy-first, local-only.
```
...
Adds [@4da/mcp-server](https://www.npmjs.com/package/@4da/mcp-server) — an MCP server providing 30 tools for developer intelligence.
