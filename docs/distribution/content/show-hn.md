...
The MCP server component (@4da/mcp-server) exposes 30 tools to Claude Code, Cursor, or any MCP client so your LLM can query trends, knowledge gaps, and signals relevant to your codebase. MIT licensed.
