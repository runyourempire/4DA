...
| **FSL (Functional Source License)** | 2년간 소스가 보이지만 오픈 소스가 아닙니다. 2년 후 Apache 2.0으로 전환. 중요한 성장기에 직접 경쟁자를 방지합니다. | 시장 포지션을 구축하는 동안 직접 경쟁이 차단됩니다. 추가 수입을 위한 프리미엄 기능. | 4DA, Sentry |
