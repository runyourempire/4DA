 ...
 * search_course tool
 *
 * Full-text search across all STREETS course modules.
 */
...
export const searchCourseTool = {
  name: "search_course",
  description: `Search across all STREETS course modules for specific topics, techniques, or concepts. Returns matching lessons with excerpts and relevance scores.
