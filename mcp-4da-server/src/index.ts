 ...
 */
/**
 * 4DA MCP Server v4.1.2 — Intelligence Platform
 *
...
async function main() {
  ...
  if (args.includes("--version") || args.includes("-v")) {
    console.log("@4da/mcp-server 4.1.2");
    return;
  }
...
`);
  ...
  console.error(`4DA MCP Server v4.1.2 started — ${toolCount} tools, stdio transport`);
