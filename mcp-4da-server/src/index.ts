 ...
 */
/**
 * 4DA MCP Server v4.4.0 — Dependency Intelligence Platform
 *
...
async function main() {
  ...
  if (args.includes("--version") || args.includes("-v")) {
    console.log("@4da/mcp-server 4.4.0");
    return;
  }
...
`);
  ...
  console.error(`4DA MCP Server v4.4.0 started — ${toolCount} tools, stdio transport`);
