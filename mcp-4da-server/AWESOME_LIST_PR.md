...
**@4da/mcp-server** provides 30 MCP tools that connect AI coding assistants (Claude Code, Cursor, Windsurf, Copilot) to a developer's local codebase and score internet content against their tech stack.
