...
export interface UiSlice {
  ...
  showSplash: boolean;
  activeView: 'briefing' | 'chapters' | 'results' | 'saved' | 'insights' | 'toolkit' | 'playbook' | 'channels' | 'profile' | 'calibrate' | 'console';
  isFirstRun: boolean;
  ...
  setActiveView: (view: 'briefing' | 'chapters' | 'results' | 'saved' | 'insights' | 'toolkit' | 'playbook' | 'channels' | 'profile' | 'calibrate' | 'console') => void;
