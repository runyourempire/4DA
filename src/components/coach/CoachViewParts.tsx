...
export const SUB_TAB_IDS: CoachSessionType[] = ['chat', 'engine_recommender', 'strategy', 'launch_review', 'progress', 'templates', 'curriculum'];

export const SUB_TAB_KEYS: Record<CoachSessionType, string> = {
...
export function TierBadge({ tier }: { tier: StreetsTier }) {
