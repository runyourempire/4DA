...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    var sdf_result = min(sdf_box(p, 0.300000, 0.040000), sdf_box(p, 0.040000, 0.300000));
    let glow_pulse = 2.500000 * (0.9 + 0.1 * sin(time * 2.0));
    let glow_result = apply_glow(sdf_result, glow_pulse);
    var color_result = vec4<f32>(vec3<f32>(glow_result), 1.0);
    color_result = vec4<f32>(color_result.rgb * vec3<f32>(1.000000, 0.300000, 0.300000), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    float sdf_result = min(sdf_box(p, 0.300000, 0.040000), sdf_box(p, 0.040000, 0.300000));
    float glow_pulse = 2.500000 * (0.9 + 0.1 * sin(time * 2.0));
    float glow_result = apply_glow(sdf_result, glow_pulse);

    vec4 color_result = vec4(vec3(glow_result), 1.0);
    color_result = vec4(color_result.rgb * vec3(1.000000, 0.300000, 0.300000), 1.0);
