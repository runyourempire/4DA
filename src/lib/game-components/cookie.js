// GAME Component: cookie — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let sdf_a = sdf_circle(p, 0.300000);
    let sdf_b = sdf_box(p, 0.120000, 0.120000);
    ...
    color_result = vec4<f32>(color_result.rgb * vec3<f32>(1.000000, 0.400000, 0.200000), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    float sdf_a = sdf_circle(p, 0.300000);
    float sdf_b = sdf_box(p, 0.120000, 0.120000);
    ...
    color_result = vec4(color_result.rgb * vec3(1.000000, 0.400000, 0.200000), 1.0);
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-cookie: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-cookie', Cookie);
})();
