// GAME Component: polar-rings — auto-generated, do not edit.
(function(){
...
class PolarRings extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-polar-rings: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-polar-rings', PolarRings);
})();
