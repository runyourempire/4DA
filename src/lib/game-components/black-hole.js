// GAME Component: black-hole — auto-generated, do not edit.
(function(){
...
class GameFlowField {
  ...
  dispatch(dt) {
    ...
    f[0] = 2; f[1] = 0.2; f[2] = 2; f[3] = this._time;
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-black-hole: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-black-hole', BlackHole);
})();
