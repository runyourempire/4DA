...
/**
 * `<game-living-field>` Web Component
 *
 * A self-contained WebGPU/WebGL2 shader component.
 *
 * @example
 * ```html
 * <game-living-field life="0" warmth="0" density="0"></game-living-field>
 * ```
 *
 * @example
 * ```typescript
 * const el = document.querySelector('game-living-field')!;
   * el.life = 0;
   * el.warmth = 0;
 * ```
 */
interface GameLivingFieldElement extends HTMLElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'game-living-field': GameLivingFieldElement;
  }
}
