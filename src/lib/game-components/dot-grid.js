// GAME Component: dot-grid — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    p = vec2<f32>(game_mod(p.x + 0.300000 * 0.5, 0.300000) - 0.300000 * 0.5, game_mod(p.y + 0.300000 * 0.5, 0.300000) - 0.300000 * 0.5);
...
void main(){
    ...
    p = vec2(mod(p.x + 0.300000 * 0.5, 0.300000) - 0.300000 * 0.5, mod(p.y + 0.300000 * 0.5, 0.300000) - 0.300000 * 0.5);
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-dot-grid: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-dot-grid', DotGrid);
})();
