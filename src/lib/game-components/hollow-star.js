// GAME Component: hollow-star — auto-generated, do not edit.
(function(){
...
class HollowStar extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-hollow-star: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-hollow-star', HollowStar);
})();
