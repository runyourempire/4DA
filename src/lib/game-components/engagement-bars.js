// game-engagement-bars.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./game-engagement-bars.js"></script>
//   <game-engagement-bars></game-engagement-bars>
...
fn fs_main(input: VertexOutput) -> @location(0) vec4f {
    ...
    // stage 0: fbm(...)
    var sdf_result = fbm2((p * 3.0), i32(2.0), 0.5, 2.0);
...
void fs_main(input: VertexOutput){
    ...
    // stage 0: fbm(...)
    float sdf_result = fbm2((p * 3.0), int(2.0), 0.5, 2.0);
...
class GameEngagementBars extends HTMLElement {
  ...
  set d0(v) { this._data.d0 = typeof v === 'number' ? v : parseFloat(v) || 0; }
  get d0() { return this._data.d0; }
  ...
  _frame() {
    ...
    // Update param values
    const data_d0 = this._data.d0 || 0;
    this._paramValues[0] = (this._arcBaseOverrides?.[0] ?? 1) + (data_d0 * 3.0);
  ...
  _initWebGL2() {
    ...
    this._glParamUniforms[0] = gl.getUniformLocation(prog, 'u_p_glow_val');
...
customElements.define('game-engagement-bars', GameEngagementBars);
export { GameEngagementBars };
export default GameEngagementBars;
