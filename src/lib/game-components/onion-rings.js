// GAME Component: onion-rings — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    for (var onion_i: i32 = 0; onion_i < i32(4.000000); onion_i = onion_i + 1) { sdf_result = abs(sdf_result) - 0.015000; }
...
void main(){
    ...
    for (int onion_i = 0; onion_i < int(4.000000); onion_i++) { sdf_result = abs(sdf_result) - 0.015000; }
...
class OnionRings extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-onion-rings: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-onion-rings', OnionRings);
})();
