...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    { let warp_x = fbm2(p * 2.000000 + vec2<f32>(0.0, 1.3), i32(6.000000), 0.600000, 0.500000);
    let warp_y = fbm2(p * 2.000000 + vec2<f32>(1.7, 0.0), i32(6.000000), 0.600000, 0.500000);
    ...
    color_result = vec4<f32>(color_result.rgb * vec3<f32>(0.900000, 0.400000, 0.100000), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    { float warp_x = fbm2(p * 2.000000 + vec2(0.0, 1.3), int(6.000000), 0.600000, 0.500000);
    float warp_y = fbm2(p * 2.000000 + vec2(1.7, 0.0), int(6.000000), 0.600000, 0.500000);
    ...
    color_result = vec4(color_result.rgb * vec3(0.900000, 0.400000, 0.100000), 1.0);
