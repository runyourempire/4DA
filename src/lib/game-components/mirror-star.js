// GAME Component: mirror-star — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    var sdf_result = sdf_star(p, 5.000000, 0.150000, 0.070000);
...
void main(){
    ...
    float sdf_result = sdf_star(p, 5.000000, 0.150000, 0.070000);
...
class MirrorStar extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-mirror-star: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-mirror-star', MirrorStar);
})();
