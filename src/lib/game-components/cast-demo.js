// GAME Component: cast-demo — auto-generated, do not edit.
(function(){
...
class CastDemo extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-cast-demo: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-cast-demo', CastDemo);
})();
