...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    p = p + vec2<f32>(sin(p.y * 4.000000 + time * 0.500000), cos(p.x * 4.000000 + time * 0.500000)) * 0.300000;
    ...
    color_result = vec4<f32>(color_result.rgb * vec3<f32>(1.000000, 0.700000, 0.300000), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    p = p + vec2(sin(p.y * 4.000000 + time * 0.500000), cos(p.x * 4.000000 + time * 0.500000)) * 0.300000;
    ...
    color_result = vec4(color_result.rgb * vec3(1.000000, 0.700000, 0.300000), 1.0);
