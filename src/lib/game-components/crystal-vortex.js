...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    var color_result = vec4<f32>(cosine_palette(sdf_result, vec3<f32>(0.500000, 0.500000, 0.500000), vec3<f32>(0.500000, 0.500000, 0.500000), vec3<f32>(1.000000, 1.000000, 0.500000), vec3<f32>(0.800000, 0.900000, 0.300000)), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    vec4 color_result = vec4(cosine_palette(sdf_result, vec3(0.500000, 0.500000, 0.500000), vec3(0.500000, 0.500000, 0.500000), vec3(1.000000, 1.000000, 0.500000), vec3(0.800000, 0.900000, 0.300000)), 1.0);
