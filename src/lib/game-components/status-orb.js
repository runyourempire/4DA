// game-status-orb.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./game-status-orb.js"></script>
//   <game-status-orb></game-status-orb>
...
class GameStatusOrb extends HTMLElement {
...
customElements.define('game-status-orb', GameStatusOrb);
export { GameStatusOrb };
export default GameStatusOrb;
