// game-scan-ring.js — Generated by GAME compiler v0.2.0
// Zero-dependency WebGPU component with WebGL2 fallback.
//   <script type="module" src="./game-scan-ring.js"></script>
//   <game-scan-ring></game-scan-ring>
...
class GameScanRing extends HTMLElement {
...
customElements.define('game-scan-ring', GameScanRing);
export { GameScanRing };
export default GameScanRing;
