// GAME Component: capsule-indicator — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    var sdf_result = sdf_line(p, vec2<f32>(-0.300000 * 0.5, 0.0), vec2<f32>(0.300000 * 0.5, 0.0)) - 0.050000;
...
void main(){
    ...
    float sdf_result = sdf_line(p, vec2(-0.300000 * 0.5, 0.0), vec2(0.300000 * 0.5, 0.0)) - 0.050000;
...
class CapsuleIndicator extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-capsule-indicator: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-capsule-indicator', CapsuleIndicator);
})();
