// GAME Component: crystal — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    var color_result = vec4<f32>(cosine_palette(sdf_result, vec3<f32>(0.800000, 0.900000, 1.000000), vec3<f32>(0.200000, 0.300000, 0.500000), vec3<f32>(0.500000, 0.500000, 0.500000), vec3<f32>(0.500000, 0.600000, 0.700000)), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    vec4 color_result = vec4(cosine_palette(sdf_result, vec3(0.800000, 0.900000, 1.000000), vec3(0.200000, 0.300000, 0.500000), vec3(0.500000, 0.500000, 0.500000), vec3(0.500000, 0.600000, 0.700000)), 1.0);
...
class Crystal extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-crystal: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-crystal', Crystal);
})();
