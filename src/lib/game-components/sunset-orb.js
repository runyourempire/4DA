// GAME Component: sunset-orb — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    var color_result = vec4<f32>(cosine_palette(sdf_result, vec3<f32>(0.500000, 0.500000, 0.500000), vec3<f32>(0.500000, 0.500000, 0.500000), vec3<f32>(1.000000, 0.700000, 0.400000), vec3<f32>(0.000000, 0.150000, 0.200000)), 1.0);
    return color_result;
}
`;
...
void main(){
    ...
    vec4 color_result = vec4(cosine_palette(sdf_result, vec3(0.500000, 0.500000, 0.500000), vec3(0.500000, 0.500000, 0.500000), vec3(1.000000, 0.700000, 0.400000), vec3(0.000000, 0.150000, 0.200000)), 1.0);
...
class SunsetOrb extends HTMLElement {
  constructor() {
    super();
  ...
  async _initRenderer() {
    ...
    if (await gpu.init()) {
      ...
      if (gl.init()) {
        ...
        console.warn('game-sunset-orb: no WebGPU or WebGL2 support');
        return;
      }
    }
    this._resize();
...
customElements.define('game-sunset-orb', SunsetOrb);
})();
