...
mod tests {
    ...
    fn test_country_to_currency() {
        assert_eq!(country_to_currency("US"), "USD");
        assert_eq!(country_to_currency("GB"), "GBP");
        assert_eq!(country_to_currency("DE"), "EUR");
        assert_eq!(country_to_currency("JP"), "JPY");
        assert_eq!(country_to_currency("AU"), "AUD");
        // Unknown country defaults to USD
        assert_eq!(country_to_currency("ZZ"), "USD");
    }
