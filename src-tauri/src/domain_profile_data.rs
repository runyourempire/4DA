...
pub(crate) fn adjacency_map() -> HashMap<&'static str, &'static [&'static str]> {
    HashMap::from([
        ...
        ("typescript", &["javascript", "nodejs", "deno", "bun", "react"]),
        ("javascript", &["typescript", "nodejs", "npm"]),
        (
            "python",
            &["pip", "pytorch", "tensorflow", "django", "flask", "fastapi", "numpy", "pandas", "jupyter"],
        ),
        ("go", &["golang", "goroutine"]),
        ...
        ("kubernetes", &["k8s", "docker", "helm", "container", "istio", "kustomize"]),
